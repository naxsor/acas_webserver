# Generated by Django 3.2.13 on 2022-07-07 17:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measu_prop', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Property Measured')),
                ('measu_prin', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Measurement principle')),
                ('image', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='sensor_images')),
                ('image_description', models.TextField(blank=True, null=True, verbose_name='Image Description')),
                ('image_diagram', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='diagram_example')),
                ('diagram_description', models.TextField(blank=True, null=True, verbose_name='Diagram Description')),
                ('image_plot', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='plot_example')),
                ('plot_description', models.TextField(blank=True, null=True, verbose_name='Plot Description')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incand_mass_conc', models.FloatField(blank=True, db_column='Incandescence Mass Concentration', null=True)),
                ('total_mass_concentratio', models.FloatField(blank=True, db_column='Total Mass per Second', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(blank=True, max_length=50, null=True)),
                ('acronym', models.CharField(blank=True, max_length=50, null=True)),
                ('info', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Information')),
                ('measu_prop', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Property Measured')),
                ('measu_prin', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Measurement principle')),
