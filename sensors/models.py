...
class acsm(models.Model):
    ...
    chl = models.FloatField(db_column='Chloride difference signal')
    nh4 = models.FloatField(db_column='Ammonium difference signal')
    no3 = models.FloatField(db_column='Nitrate difference signal')
    org = models.FloatField(db_column='Organic difference signal')
    so4 = models.FloatField(db_column='Sulphate difference signal')
    rie_chl = models.FloatField()
    rie_nh4 = models.FloatField()
    rie_no3 = models.FloatField()
    rie_org = models.FloatField()
    rie_so4 = models.FloatField()
    f43 = models.FloatField()
    f44 = models.FloatField()
    f57 = models.FloatField()
    f60 = models.FloatField()
    hoa = models.FloatField(db_column='Hydrocarbon-like aerosol')
    ooa = models.FloatField(db_column='Oxygenated organic aerosol')
    ce = models.FloatField(db_column='Collection Efficiency')
    reserved_0 = models.FloatField(db_column='Reserved 0')
    reserved_1 = models.FloatField(db_column='Reserved 1')
    reserved_2 = models.FloatField(db_column='Reserved 2')
    reserved_3 = models.FloatField(db_column='Reserved 3')
    ie_ionspg = models.FloatField(db_column='Calibration Value')
    abref = models.IntegerField(db_column='Calibration airbeam reference')
    ab_total = models.IntegerField(db_column='Average airbeam total measurement')
    ab_bkgd = models.IntegerField(db_column='Average airbeam background measurement')
    flow_cc = models.FloatField(db_column='Flowrate')
    flow_p0 = models.FloatField(db_column='Flowrate calibration offset')
    flow_p1 = models.FloatField(db_column='Flowrate calibration slope')
    n_total = models.IntegerField(db_column='MS total average')
    n_bkgd = models.IntegerField(db_column='MS background average')
    baseline = models.IntegerField(db_column='DAQ Baseline')
    threshold = models.IntegerField(db_column='DAQ Threshold')
    mzCal_p1 = models.FloatField(db_column='Mass calibration p1')
    mzCal_p2 = models.FloatField(db_column='Mass calibration p2')
    ratio40div28 = models.FloatField(db_column='Ratio of integrated signal')
    reserved_4 = models.FloatField(db_column='Reserved 4')
    reserved_5 = models.FloatField(db_column='Reserved 5')
    reserved_6 = models.FloatField(db_column='Reserved 6')
    reserved_7 = models.FloatField(db_column='Reserved 7')
    rbp = models.FloatField(db_column='Reflector backplane voltage')
    rg = models.FloatField(db_column='Reflector grid voltage')
    lens = models.FloatField(db_column='Lens voltage')
    detector = models.FloatField(db_column='Detector voltage')
    hv_spare = models.FloatField(db_column='Spare HV voltage')
    pulser = models.FloatField(db_column='Pulser voltage')
    lens2 = models.FloatField(db_column='Lens 2 voltage')
    deflector = models.FloatField(db_column='Deflector voltage')
    deflector_f = models.FloatField(db_column='Deflector flange voltage')
    ion_ex = models.FloatField(db_column='Ion extractor Voltage')
    lens1 = models.FloatField(db_column='Lens 1 voltage')
    hb = models.FloatField(db_column='Heater bias voltage')
    ion_ch = models.FloatField(db_column='Ion chamber Voltage')
    filament_v = models.FloatField(db_column='Filament Voltage')
    filament_emm = models.FloatField(db_column='Filament emission current')
    filament_i = models.FloatField(db_column='Filament supply current')
    filament_n = models.FloatField(db_column='Filament number in use')
    interlock = models.IntegerField(db_column='Interlock active')
    hvp = models.FloatField(db_column='HV positive supply voltage')
    hvn = models.FloatField(db_column='HV negative supply voltage')
    turbo_speed = models.FloatField(db_column='Turbo rotation frequency')
    turbo_power = models.FloatField(db_column='Turbo power consumption')
    force_pc = models.FloatField(db_column='Forepump rotation')
    tps_temp = models.FloatField(db_column='Temperature in TPS')
    press_ioniser = models.FloatField(db_column='Pressure in ioniser')
    press_inlet = models.FloatField(db_column='Pressure in inlet')
    ain_3 = models.FloatField(db_column='Analogue input channel 3')
    ain_4 = models.FloatField(db_column='Analogue input channel 4')
    ain_5 = models.FloatField(db_column='Analogue input channel 5')
    ain_6 = models.FloatField(db_column='Analogue input channel 6')
    heater_pwm = models.FloatField(db_column='Heater PWM setpoint')
    heater_i = models.FloatField(db_column='Heater current')
    heater_v = models.FloatField(db_column='Heater voltage')
    heater_t = models.FloatField(db_column='Heater temperature')
    servo2_pwm = models.FloatField(db_column='Inlet servo position')
    servo3_pwm = models.FloatField(db_column='Filter servo position')

    class Meta:
        managed = True
        db_table = 'sensor_acsm'
